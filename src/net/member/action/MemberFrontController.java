...
public class MemberFrontController extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		MemberFrontService memberFrontService = new MemberFrontService();
		// ログイン画面
		...
		// ログイン処理
			...
			try {
				forward = memberFrontService.MemberLoginAction(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// 会員登録処理
			...
			try {
				forward = memberFrontService.MemberJoinAction(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// 会員情報修正画面
			...
			try {
				forward = memberFrontService.MemberModifyAction_1(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// 会員情報修正処理
			...
			try {
				forward = memberFrontService.MemberModifyAction_2(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// 会員退会処理
			...
			try {
				forward = memberFrontService.MemberDeleteAction(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// アカウント確認処理
			...
			try {
				forward = memberFrontService.MemberIDCheckAction(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// 会員情報探す処理
			...
			try {
				forward = memberFrontService.MemberFindAction(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		// 郵便番号検索処理
			...
			try {
				forward = memberFrontService.MemberZipcodeAction(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
